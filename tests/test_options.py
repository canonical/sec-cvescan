...
def test_set_manifest_mode(mock_args):
...
def test_set_experimental_nagios_manifest(mock_args):
    mock_args.experimental = True
    mock_args.manifest = True
    mock_args.nagios = True
    opt = Options(mock_args, "focal")
...
def test_set_distrib_codename(mock_args):
    opt = Options(mock_args, "focal")

    assert opt.distrib_codename == "focal"


def test_set_distrib_codename_manifest(mock_args):
...
def test_set_oval_file_manifest(mock_args):
...
def test_set_oval_file_experimental_manifest(mock_args):
    mock_args.experimental = True
...
def test_set_oval_url_manifest(mock_args):
    mock_args.manifest = "xenial"
    opt = Options(mock_args, "focal")
...
def test_set_oval_url_experimental(mock_args):
    mock_args.experimental = True
    opt = Options(mock_args, "focal")
...
def test_set_oval_url_experimental_manifest(mock_args):
    mock_args.experimental = True
    mock_args.manifest = "focal"
    opt = Options(mock_args, "focal")
...
def test_set_download_oval_file_manifest(mock_args):
    mock_args.manifest = "xenial"
    opt = Options(mock_args, "focal")
...
def test_set_download_oval_file_experimental_manifest(mock_args):
    mock_args.experimental = True
    mock_args.manifest = "focal"
    opt = Options(mock_args, "focal")
...
def test_set_manifest_file(mock_args):
    opt = Options(mock_args, "focal")

    assert opt.manifest_file is None


def test_set_manifest_file_default(mock_args):
    mock_args.manifest = "bionic"
    opt = Options(mock_args, "focal")
...
def test_invalid_manifest_file_missing_manifest(monkeypatch, mock_args):
    monkeypatch.setattr(os.path, "isfile", lambda x: True)
